...
if(isset($_REQUEST['action']))
{
    ...
    {
        case 'actualizar':
            $alm->__SET('codigo_producto',              $_REQUEST['id']);
...
?>
  ...
  <!--<link rel="stylesheet" href="http://yui.yahooapis.com/pure/0.5.0/pure-min.css"> !-->
     <!--<tr><td style="padding:5px"></td></tr> !-->
                ...
                <form action="?action=<?php echo $alm->codigo_producto > 0 ? 'registrar' : 'actualizar'; ?>" method="post" class="navbar-form navbar-default" >
             ...
             <div class="table-responsive">
                    ...
                    <?php foreach($model->Listar() as $r): ?>
                        <tr>
                            ...
                            <td>
                                <a href="?action=editar&id=<?php echo $r->codigo_producto; ?>">Editar</a>
                            </td>
                            <td>
