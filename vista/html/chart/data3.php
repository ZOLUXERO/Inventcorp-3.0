...
// Fetch the data
$query = "select codigo_producto,precio_entrada,precio_salida from productos where not codigo_producto='$pru' order by fecha_ingreso ASC";
...
$query2 = "select codigo_producto,precio_entrada,precio_salida from productos where codigo_producto='$pru'";
